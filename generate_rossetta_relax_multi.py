...
folder = "evaluate_candidate_sequence_multi"

data_dir_name = [("function_0","component_1"), ("function_0","process_0"), ("function_1","process_1")
,("process_0","component_1")
   ,("process_1","component_0")]

data_dir_name = [data_dir_name[2]]
...
with ProcessPoolExecutor() as executor:
    futures = []
    for dir_name1,dir_name2 in data_dir_name:
        pdb_folder_path = os.path.join(folder, dir_name1+"_"+dir_name2, 'pdb')
