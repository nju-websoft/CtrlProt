    ...
    def get_plddt_scores(self, output_pdb_folder, sequences,num = -1):
        ...
        for i in tqdm(range(len(temp_sequences))):
            ...
            try:
                ...
                with open("/data/anonymity/CtrlProt/wrong_sample.txt",'a') as file:
...
def get_pdb():
    ...
    parser.add_argument("--dataset_path", type=str, default="./generate_candidate_sequence_multi")
    parser.add_argument("--output_path", type=str, default="./evaluate_candidate_sequence_multi")
    ...
    task_name_list = [("function_0","process_0")]

    
    for task_name1, task_name2 in task_name_list:
        
        input_file_path = os.path.join(folder_path, task_name1+"_"+task_name2, "result.txt")
        output_file_path = os.path.join(output_folder_path, task_name1+"_"+task_name2, "result2.txt")
        output_pdb_folder = os.path.join(output_folder_path, task_name1+"_"+task_name2, 'pdb')
